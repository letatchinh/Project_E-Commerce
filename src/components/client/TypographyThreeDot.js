...
export default function TypographyThreeDot({children,className}) {
  ...
  return (
    ...
    <Typography fontSize= "calc(0.35vw + 10px)" color={mainColorText} className={className} variant="body1" fontWeight="500" textOverflow='ellipsis' width='fit-content' maxWidth='100%' overflow='hidden'>{children}</Typography>
  </Tooltip>
  )
}
